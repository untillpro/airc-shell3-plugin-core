...
export const TICKET_ORDER_TYPE = 3;
export const TICKET_PROFORMA_TYPE = 4;
export const TICKET_NEXT_COURSE_TYPE = 5;
export const TICKET_TRANSFER_TYPE = 6;
export const TICKET_VOIDS_TYPE = 7;

export const DEFAULT_DEVICE_TOKEN_TTL = 60000;
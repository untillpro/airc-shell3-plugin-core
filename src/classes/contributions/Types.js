...
export const C_REPORT_VALIDATOR = "checker";
export const C_REPORT_EXTENDER = "extender";
...
export const C_COLLECTION_ELEMENTS = "elements";
...
export const C_COLLECTION_FILTERS = "filter_by";
